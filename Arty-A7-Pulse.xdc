...
# Add 0.5ns Button (btn 2)
set_property -dict { PACKAGE_PIN B9    IOSTANDARD LVCMOS33 } [get_ports { btn_add_half_ns }]; 
# Subtract 0.5ns Button (btn 3)
set_property -dict { PACKAGE_PIN B8    IOSTANDARD LVCMOS33 } [get_ports { btn_sub_half_ns }]; 
...
## -----------------------------------------------------------------------------
set_property -dict { PACKAGE_PIN U12   IOSTANDARD LVCMOS33 SLEW FAST } [get_ports { output_pulse[0] }]; 
set_property -dict { PACKAGE_PIN V12   IOSTANDARD LVCMOS33 SLEW FAST } [get_ports { output_pulse[1] }]; 
set_property -dict { PACKAGE_PIN V10   IOSTANDARD LVCMOS33 SLEW FAST } [get_ports { output_pulse[2] }]; 
set_property -dict { PACKAGE_PIN V11   IOSTANDARD LVCMOS33 SLEW FAST } [get_ports { output_pulse[3] }]; 
set_property -dict { PACKAGE_PIN U14   IOSTANDARD LVCMOS33 SLEW FAST } [get_ports { output_pulse[4] }]; 
